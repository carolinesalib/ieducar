...
class Portabilis_Business_Professor {
  ...
  public static function turmasAlocado($escolaId, $serieId, $userId) {
    $sql = "select distinct cod_turma as id, nm_turma as nome from pmieducar.turma, pmieducar.turma_serie
            where ref_ref_cod_escola = $1 and turma_serie.ref_cod_turma = turma.cod_turma
            and (ref_ref_cod_serie = $2 or turma_serie.ref_cod_serie = $2) and ativo = 1 and
