...
/**
 * Portabilis_View_Helper_Input_MultipleSearchMultiSeriado class.
 *
 * @author    Caroline Salib <caroline@portabilis.com.br>
 * @category  i-Educar
 * @license   @@license@@
 ...
 */
class Portabilis_View_Helper_Input_Resource_MultipleSearchMultiSeriado extends Portabilis_View_Helper_Input_MultipleSearch {

  protected function getOptions($resources) {
    return $this->insertOption(null, '', $resources);
  }

  public function multipleSearchMultiSeriado($attrName, $options = array()) {
    $defaultOptions = array('objectName'    => 'multiseriado',
                            'apiController' => 'MultiSeriado',
                            'apiResource'   => 'multiseriado-search');
  ...
  protected function loadAssets() {
    ...
    $jsFile = '/modules/Portabilis/Assets/Javascripts/Frontend/Inputs/Resource/MultipleSearchMultiSeriado.js';
    Portabilis_View_Helper_Application::loadJavascript($this->viewInstance, $jsFile);
  }
}